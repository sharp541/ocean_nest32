...
// enter
const uint16_t PROGMEM ent_r_combo[] = {KC_O, KC_E, COMBO_END};
const uint16_t PROGMEM ent_l_combo[] = {KC_S, KC_I, COMBO_END};

// backspace
const uint16_t PROGMEM bspc_r_combo[] = {KC_N, KC_O, KC_E, COMBO_END};
const uint16_t PROGMEM bspc_l_combo[] = {KC_S, KC_I, KC_T, COMBO_END};

// up arrow
const uint16_t PROGMEM uarr_r_combo[] = {KC_A, KC_M, COMBO_END};
const uint16_t PROGMEM uarr_l_combo[] = {KC_K, KC_U, COMBO_END};

// down arrow
const uint16_t PROGMEM darr_r_combo[] = {KC_A, KC_M, KC_N, COMBO_END};
const uint16_t PROGMEM darr_l_combo[] = {KC_K, KC_U, KC_T, COMBO_END};

// right arrow
const uint16_t PROGMEM rarr_r_combo[] = {KC_N, KC_M, COMBO_END};
const uint16_t PROGMEM rarr_l_combo[] = {KC_U, KC_T, COMBO_END};

// left arrow
const uint16_t PROGMEM larr_r_combo[] = {KC_N, KC_A, COMBO_END};
const uint16_t PROGMEM larr_l_combo[] = {KC_T, KC_K, COMBO_END};

// home
const uint16_t PROGMEM home_r_combo[] = {KC_W, KC_M, COMBO_END};

// end
const uint16_t PROGMEM end_r_combo[] = {KC_O, KC_W, KC_M, COMBO_END};

// esc
const uint16_t PROGMEM esc_r_combo[] = {KC_P, KC_Z, COMBO_END};

// alt
const uint16_t PROGMEM alt_l_combo[] = {KC_M, KC_G, COMBO_END};
